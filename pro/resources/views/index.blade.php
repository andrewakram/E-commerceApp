...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{URL::to('index')}}">SB Admin v2.0</a>
        </div>
        <!-- /.navbar-header -->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{URL::to('/categories')}}">Show All Categories</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{URL::to('/products')}}">Show All Products</a>
                            </li>
                            <li>
                                <a href="{{URL::to('/add_product')}}">Add New Product</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{URL::to('/brands')}}">Show All Brands</a>
                            </li>
                            <li>
                                <a href="{{URL::to('/add_brand')}}">Add New Brand</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
<script type="text/javascript">
    ...
    $(document).on('click','#deletes',function (e) {
        ...
        bootbox.confirm(' Are you  sure ?'+ product_id  ,function (confirmed) {
